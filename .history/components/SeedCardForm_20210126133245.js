    ...
    const createSeedCard = async (data) => {
        ...
        try {
            await fetch('/api/createSeedCard', {
                method: 'POST',
                body: JSON.stringify({ userEmail, plantCategory, nameScientific, nameCommon, typeOption, height, siteLight, spacing, daysToGerminate, plantingDepth, daysToMaturity, pinch, sowInsideWeeks, sowInsideBeforeOrAfter, 
