        ...
        try {
            await fetch('/api/updateSeedCard', {
                ...
                body: JSON.stringify({ plantCategory, nameScientific, nameCommon, typeOption, height, 
                    ...
                    sowInsideWeeks, sowInsideBeforeOrAfter, sowInsideRecommended, sowOutsideWeeks, sowOutsideBeforeOrAfter, sowOutsideRecommended, successiveSowing, sowEveryXStartWeeks, sowEveryXEndWeeks, notes, harvestInstructions, id }),
