    ...
    const updateSeedCard = async (data) => {
        ...
        try {
            await fetch('/api/updateSeedCard', {
                method: 'PUT',
                body: JSON.stringify({ plantCategory, nameScientific, nameCommon, typeOption, height, siteLight, spacing, daysToGerminate, plantingDepth, daysToMaturity, pinch, sowInsideWeeks, sowInsideBeforeOrAfter, sowInsideRecommended, sowOutsideWeeks, 
