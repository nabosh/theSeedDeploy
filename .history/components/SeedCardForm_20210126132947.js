        ...
        try {
            await fetch('/api/createSeedCard', {
                ...
                body: JSON.stringify({ userEmail, plantCategory, nameScientific, nameCommon, 
                    ...
                    sowInsideRecommended, sowOutsideWeeks, sowOutsideBeforeOrAfter, sowOutsideRecommended, successiveSowing, sowEveryXStartWeeks, sowEveryXEndWeeks, notes, harvestInstructions }),
                headers: {
