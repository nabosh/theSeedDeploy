...
export default function SeedCardForm({ seedcard }) {
    ...
    const updateSeedCard = async (data) => {
        const { userEmail, plantCategory, nameScientific, nameCommon, typeOption, 
            ...
            sowInsideWeeks, sowInsideBeforeOrAfter, sowInsideRecommended, sowOutsideWeeks, sowOutsideBeforeOrAfter, sowOutsideRecommended, successiveSowing, sowEveryXStartWeeks, sowEveryXEndWeeks, notes, harvestInstructions } = data;
